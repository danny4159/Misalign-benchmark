...
class CycleGANModule(BaseModule):
    ...
    def backward_G(self, real_a, real_b, fake_a, fake_b, lambda_cycle=100, lambda_identity=1):
        # GAN loss D_A(G_A(A))
        ...
        # combined loss
        loss_G = loss_G + loss_cycle + loss_identity
        return loss_G
    ...
    def training_step(self, batch: Any, batch_idx: int):
        ...
        with optimizer_G.toggle_model():
            loss_G = self.backward_G(real_a, real_b, fake_a, fake_b, self.params.lambda_cycle, self.params.lambda_identity)
...
if __name__ == "__main__":
    _ = CycleGANModule(None, None, None)