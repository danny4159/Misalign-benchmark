...
class AdaINGen(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, dim, style_dim, n_downsample, n_res, activ, pad_type, mlp_dim):
        super(AdaINGen, self).__init__()
        # style encoder
        self.enc_style = StyleEncoder(4, input_nc, dim, style_dim, norm='none', activ=activ, vae=False)
